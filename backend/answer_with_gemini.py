...
from gemini_generator import GeminiAnswerGenerator
from retriever import DEFAULT_CHROMA_DIR, Retriever


def build_parser():
    parser = argparse.ArgumentParser(
        description="Generate a grounded answer with Gemini using retrieved website context."
    )
